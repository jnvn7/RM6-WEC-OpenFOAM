#!/usr/bin/env python3
##--------------------------------------------------------------------------------#
# Script to plot the 6DoF Motion from  Output.txt file generated by extractLog.sh
...
for case in sys.argv[1:]:
    time, surge, heave, pitch, roll, yaw = readData(os.path.join(case,"Output.txt"))

    axs[0].plot(time, surge, label=case)
    axs[1].plot(time, heave, label=case)
    axs[2].plot(time, pitch, label=case)
    axs[3].plot(time, roll, label=case)
